...
Vitis provides a unified flow for developing FPGA accelerated application targeted to either data-center or embedded platforms. This tutorial provides instructions for building and running in GUI mode on VCK190 cards. These instructions can be easily adapted to other Xilinx cards.
