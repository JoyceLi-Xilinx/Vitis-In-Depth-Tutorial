...
5. On the Project Type page, make the following selections:  
   ...
   3. Click **Next**.
6. On the Default Part page select **Boards**, and enter `vck190` in the Search field.
      1. Select **Versal VCK190 Evaluation Platform**, and click **Next** to proceed.
...
3. Enter the name of the register in the Add Register dialog box according to the table above, and click **OK**.
